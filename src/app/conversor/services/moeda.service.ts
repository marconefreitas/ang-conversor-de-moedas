...
import { BoxMoeda } from '../models/BoxMoeda';
import { Moeda } from '../models/Moeda';
import { MoedaSigla } from '../models/MoedaSigla';
...
export class MoedaService {
  ...
  Email : marcfreitas0@gmail.com
  */
  private moedas : Moeda[];
  //private moedaSigla : MoedaSigla = new MoedaSigla(new Moeda());
